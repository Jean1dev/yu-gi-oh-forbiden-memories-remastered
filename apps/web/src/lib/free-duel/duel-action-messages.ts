...
const REFUSAL_MESSAGES: Readonly<Record<string, string>> = {
  ...
  spell_requires_target: "Escolha o monstro que essa magia vai atingir.",
  spell_target_not_allowed: "Essa magia nao escolhe alvo.",
  spell_target_not_monster_zone: "Escolha uma zona de monstro.",
  spell_target_out_of_reach: "Essa magia nao alcanca esse lado do campo.",
  spell_target_zone_empty: "Nao ha monstro nessa zona.",
  spell_target_not_defending: "Escolha um monstro em posicao de defesa.",
